...
define( function ( require ) {
    ...
    UsersModule.controller( 'UsersDetailsCtrl', [ '$scope', '$stateParams', '$translate', 'events', 'UsersService', 'LoginsService', 'ActivitiesService', 'CoursesService', 'AssignmentsService', 'DiscussionsService', 'CommentsService', 'QuestionariesService', 'FilesService', UsersDetailsCtrl ] );
