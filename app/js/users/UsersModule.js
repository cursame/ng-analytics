...
define( function ( require ) {
    ...
    UsersModule.controller( 'UsersDetailsCtrl', [ '$scope', '$stateParams', '$translate', 'UsersService', 'LoginsService', 'CoursesService', 'AssignmentsService', 'DiscussionsService', 'CommentsService', 'QuestionariesService', UsersDetailsCtrl ] );
